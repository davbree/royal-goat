...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://dca0aab8287a.ngrok.io/pull/602cd6f4d30699674beba610
...
To start editing your site, you can use the Sanity interface at https://royal-goat-cd6f4.sanity.studio/.
...
Generated at `2021-02-17T08:44:43.428Z` by Stackbit version `0.3.49-staging.0`.